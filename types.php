     ...
     <!-- <tbody> -->
        ...
        ?> 
         ...
         <?php echo $average_rate; ?></p></span>
            ...
            <a href="services-details.php?details=<?php echo $row['service_id']; ?>" class="btn btn-primary">View Details</a>  
        </div>
                    </div>
                  </div>
                </div>
         ...
         <?php }  } else {  foreach ($run_services as $value) { ?>  
              <!-- loop this card -->
              <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="inner">
                  <div class="card">
